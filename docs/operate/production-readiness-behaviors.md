...
| 45 | Bulk import | A user has existing harness-local skills and instructions. | Run `agents import`. | Eligible local skills and instructions are adopted into the agents repo, already locked entries are skipped, and plugin-managed skills are not taken over. |
