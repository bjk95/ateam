...
/// Remove a regular file or directory agents wrote before symlink-only
/// installs. No-op if absent. Refuses to remove symlinks (those go through
/// `uninstall_path`) or other unexpected types.
